...
const Hero = () => {
  return (
    <>
      <div className="w-full xl:h-[500px] h-[750px] md:h-auto xl:mt-[-5rem] mt-[-5rem] md:mt-[-8rem] md:mb-16">
        <div className="container lg:w-11/12 m-auto flex justify-center">
         <div className="xl:w-[100%] w-[90%] xl:flex xl:flex-row flex flex-col-reverse items-center gap-[10%]">
